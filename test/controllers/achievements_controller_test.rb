...
class AchievementsControllerTest < ActionController::TestCase
  ...
  #    post :create, achievement: { what: @achievement.what, when: @achievement.when }
  #  end
  ...
  #  patch :update, id: @achievement, achievement: { what: @achievement.what, when: @achievement.when }
  #  assert_redirected_to achievement_path(assigns(:achievement))
  #end
