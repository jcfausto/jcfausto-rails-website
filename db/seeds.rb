...
About.create!([
  ...
  {title: "EARLY LIFE", description: "Read more about my endevours on my blog, <a href=\"#\">right here.</a>", order: 4},
...
Project.create!([
  ...
  {image_file_name: "project_missing_thumb.jpg", image_content_type: "image/jpeg", image_file_size: 32965, image_updated_at: "2015-11-08 13:34:09", name: "ManyPages iPhone App", url: "http://manypagesapp.com", order: 2, visible: true},
  {image_file_name: "project_missing_thumb.jpg", image_content_type: "image/jpeg", image_file_size: 32965, image_updated_at: "2015-11-08 17:08:43", name: "Easypress - WP Theme", url: "http://easypress.jcfausto.com/", order: 3, visible: true}
])
Skill.create!([
